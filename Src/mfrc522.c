...
static MFRC522_Status_t MFRC522_Request(uint8_t reqMode, uint8_t* TagType);
static MFRC522_Status_t MFRC522_ToCard(uint8_t command, uint8_t* sendData, uint8_t sendLen, uint8_t* backData, uint16_t* backLen);
static MFRC522_Status_t MFRC522_Anticoll(uint8_t* serNum);
...
static MFRC522_Status_t MFRC522_Auth(uint8_t authMode, uint8_t BlockAddr, uint8_t* Sectorkey, uint8_t* serNum);
static MFRC522_Status_t MFRC522_Read(uint8_t blockAddr, uint8_t* recvData);
static MFRC522_Status_t MFRC522_Write(uint8_t blockAddr, uint8_t* writeData);
static void MFRC522_Halt(void);

void MFRC522_Init(void) {
//MFRC522_InitPins();
//M_SPI_Init(MFRC522_SPI, MFRC522_SPI_PINSPACK);
...
MFRC522_Status_t TMFRC522_Compare(uint8_t* CardID, uint8_t* CompareID) {
	uint8_t i;
	for (i = 0; i < 5; i++) {
